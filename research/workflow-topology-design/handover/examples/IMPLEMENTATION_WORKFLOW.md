...
```bash
./research/workflow-topology-design/handover/prototype/query-workflow-queue.sh implementation
```
...
**Entry Points:**
- From Research workflow (validated approach)
- From Triage workflow (clear requirements)
- From Tech Debt workflow (analysis complete)
- From Product Prioritization (prioritized items)
...
Implementation revealed technical debt that should be analyzed.
...
./research/workflow-topology-design/handover/prototype/handover-issue.sh \
  $ISSUE implementation tech-debt "Implementation revealed technical debt"
```
...
```bash
./research/workflow-topology-design/handover/prototype/handover-issue.sh \
  $ISSUE implementation research "Implementation revealed unknowns requiring validation"
```
...
```bash
./research/workflow-topology-design/handover/prototype/handover-issue.sh \
  $ISSUE implementation triage "Requirements unclear, needs reassessment"
```
