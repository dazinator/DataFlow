...
```bash
./research/workflow-topology-design/handover/prototype/query-workflow-queue.sh process-modeling
```

**Entry Points:**
- From Triage workflow (process improvement identified)
- From `.github/workflow-improvements.md` (Smart Mode bulk processing)
- Ad-hoc workflow improvement proposals
...
**When**: Workflow improvements implemented and tested
...
**Results**: All test scenarios PASS.
...
**When**: Process modeling reveals need for workflow reassessment

```bash
./research/workflow-topology-design/handover/prototype/handover-issue.sh \
  $ISSUE process-modeling triage "Process improvements complete, issue needs reassessment"
```

### Handover to Research

**When**: Process improvement requires technical research

```bash
./research/workflow-topology-design/handover/prototype/handover-issue.sh \
  $ISSUE process-modeling research "Improvement requires technical validation"
```
