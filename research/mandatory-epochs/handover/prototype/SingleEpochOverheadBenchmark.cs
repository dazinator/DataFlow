...
/// <summary>
/// Benchmark to measure the overhead of single-epoch wrapping.
/// Compares plain stream iteration vs single-epoch wrapped stream iteration.
/// </summary>
public class SingleEpochOverheadBenchmark
{
        ...
        [EnumeratorCancellation] CancellationToken ct = default)
    {
        ...
        var epochVector = EpochVector.FromSingleSource("benchmark-source", 1);
        yield return new EpochStream<int>(epochVector, plainStream);
    }
