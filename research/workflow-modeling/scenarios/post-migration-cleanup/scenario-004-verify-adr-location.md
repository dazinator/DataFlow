...
- OR if workflow-specific, stay in `.team/adr/`
...
**Notes**:
- ✅ `.team/adr/` contains workflow-specific ADR: "Workflow State Storage Using GitHub Labels"
...
- Recommendation: Keep in `.team/adr/` since it's workflow-system-specific
