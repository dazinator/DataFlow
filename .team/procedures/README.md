...
3. **[Work Item Creation](work-item-creation.md)** - Common patterns for creating work items
4. **[Handover](handover.md)** - Transitioning work items between duties

### Communication & Feedback

5. **[Comment Patterns](comment-patterns.md)** - Standard comment formats and conventions
6. **[Self-Improvement](self-improvement.md)** - Submitting workflow feedback
