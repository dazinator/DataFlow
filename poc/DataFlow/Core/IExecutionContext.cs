...
/// Implementations should be immutable and contain information about what triggered the dataflow execution.
/// </summary>
/// <remarks>
/// Example implementations:
/// - ScheduledTriggerContext - for cron/scheduled jobs
/// - MessageQueueTriggerContext - for message-driven execution
/// - WebRequestTriggerContext - for request-driven execution
/// </remarks>
...
public interface IExecutionContext
{
    ...
    /// Contains trigger-specific information like tenant ID, message metadata, request details, etc.
    /// Available to all blocks and actors during execution.
    /// </summary>
